% This script reproduces the Figure 3 of our paper.
...
%% save results
save(sprintf('%s/result/Figure_3', pwd));
...
for i = 1:3
    ...
    saveas(gca,sprintf('plot/figure_3%s', mark1(i)), 'png');
end
...
for i = 1:3
    ...
    saveas(gca,sprintf('plot/figure_3%s', mark2(i)), 'png');
end
...
for i = 1:3
    ...
    saveas(gca,sprintf('plot/figure_3%s', mark3(i)), 'png');
end
