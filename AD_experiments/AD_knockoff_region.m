...
% Results for split Knockoffs are shown in result_full. Result for
% Knockoffs are shown in result_knockoff.
...
%% Data Preprocessing
addpath('C:\Users\Yang\desktop\Split_Knockoffs');
addpath('C:\Users\Yang\desktop\Split_Knockoffs\AD_experiments\data\AALfeat');
%% Response Variable Y
% Label for 15T data
