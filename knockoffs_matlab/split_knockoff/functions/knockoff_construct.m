function [A_beta,A_gamma,tilde_A_gamma,tilde_y] = knockoff_construct(nu,X,D,y, s_size)
% this function generate design matrix and response variable for variable
% splitting regression. 
% this function also calculate the knockoff copy for A_gamma
...
% generate s
diag_s = sparse(diag(s_size * min(eig(C)) * ones(size(C,1),1)));
